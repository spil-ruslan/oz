...
class RedHatCDYumGuest(RedHatCDGuest):
    ...
    def _internal_customize(self, libvirt_xml, action):
        ...
        if action == "gen_only":
            ...
            modified_xml = self._modify_libvirt_xml_diskimage(modified_xml,
                                                              cow_diskimage,
                                                              'qcow2')
        ...
        try:
            ...
            if action == "gen_only":
                # no need to teardown because we simply discard the
                # file containing those changes
    ...
    def _modify_libvirt_xml_diskimage(self, libvirt_xml, new_diskimage, image_type):
        ...
        # at the time this function was added, all boot disk device
        # stanzas have a driver section - even raw images
        if len(driver) == 1:
